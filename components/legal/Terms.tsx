            ...
            <div className="prose prose-slate max-w-none space-y-6">
                ...
                <section>
                    ...
                    <p className="text-slate-600 text-sm">
                        ...
                        <br/>4.3 <strong>Opzegging:</strong> Klanten kunnen hun abonnement maandelijks opzeggen met inachtneming van een opzegtermijn van één maand, tenzij een vaste looptijd is overeengekomen (zoals bij het founding-tarief: twaalf maanden).
                        <br/>4.4 <strong>60-dagen-garantie:</strong> Indien ZenTrack in de eerste 60 dagen van het abonnement een lagere besparing aanwijst in het besparingsrapport dan de abonnementskosten over die periode, mag de klant het abonnement per direct beëindigen en betaalt ZenTrack het verschil terug. Voorwaarde is dat de klant binnen 30 dagen na aanvang de volledige inkoopadministratie van de voorafgaande twaalf maanden heeft geüpload (alle leveranciers, alle maanden). De garantie ziet op door ZenTrack aangewezen besparing op inkoopprijzen; tijdsbesparing en overige voordelen vallen buiten de berekening. Het beëindigingsrecht uit dit artikel geldt uitsluitend wanneer de aangewezen besparing lager is dan de abonnementskosten. Deze garantie geldt voor abonnementen tot en met vier locaties; bij vijf of meer locaties gelden de afspraken uit de overeenkomst.
                    </p>
                </section>
